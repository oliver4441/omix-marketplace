    ...
    <div className="page-enter relative z-10">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 mb-8">
          ...
          />
          <StatCard
            icon={<svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M20.25 7.5l-.625 10.632a2.25 2.25 0 01-2.247 2.118H6.622a2.25 2.25 0 01-2.247-2.118L3.75 7.5m8.25 3.25h3M12 17.25h.008v.008H12v-.008z" /></svg>}
            ...
            <div className="glass-card">
              ...
              {listings.length === 0 ? (
                <div className="p-8 text-center">
                  <svg className="w-12 h-12 text-slate-600 mx-auto mb-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M20.25 7.5l-.625 10.632a2.25 2.25 0 01-2.247 2.118H6.622a2.25 2.25 0 01-2.247-2.118L3.75 7.5M8.25 3.25h.008v.008H8.25V-.25z" /></svg>
                        ...
                        {l.listing_images?.find((i) => i.is_primary)?.image_url ||
                         l.listing_images?.[0]?.image_url ? (
                          ...
                          <div className="w-full h-full flex items-center justify-center">
                            <svg className="w-5 h-5 text-slate-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M20.25 7.5l-.625 10.632a2.25 2.25 0 01-2.247 2.118H6.622a2.25 2.25 0 01-2.247-2.118L3.75 7.5M8.25 3.25h.008v.008H8.25V-.25z" /></svg>
                          </div>
                        )}
                      </div>
                  ...
                  {orders.slice(0, 5).map((o) => {
                    ...
                    return (
                      <div key={o.id} className="p-3 flex items-center gap-3">
                        ...
                        >
                          {isBuyer ? (
                            <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M15.75 10.5V6a3.75 3.75 0 10-7.5 0v4.5" /></svg>
                          ) : (
