  ...
  return (
    <div className="min-h-[70vh] relative flex items-center justify-center">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute w-[400px] h-[400px] rounded-full opacity-[0.04]" style={{ background: 'radial-gradient(circle, #10b981, transparent 70%)', top: '30%', left: '50%', transform: 'translateX(-50%)', animation: 'preloaderPulse 2s ease-in-out infinite' }} />
      </div>
      ...
      <div className="relative z-10 text-center">
        ...
        <div className="relative w-16 h-16 mx-auto mb-5">
          ...
          <div className="absolute inset-[3px] rounded-[13px] bg-[#060a14] flex items-center justify-center">
            <svg className="w-7 h-7 text-emerald-400" width={28} height={28} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
