      ...
      <div className="aspect-[4/3] relative overflow-hidden bg-white/5">
        {imageUrl && !imgError ? (
          ...
          <div className="w-full h-full flex flex-col items-center justify-center bg-gradient-to-br from-white/[0.02] to-white/[0.05]">
            <svg className="w-10 h-10 text-slate-600" width={40} height={40} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <div className="p-3.5">
        ...
        {location && (
          <div className="flex items-center gap-1.5 mt-2">
            <svg className="w-3 h-3 text-slate-600 shrink-0" width={12} height={12} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" /><path strokeLinecap="round" strokeLinejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" /></svg>
        ...
        {sellerName && (
          <div className="flex items-center gap-2 mt-2.5 pt-2.5 border-t border-white/5">
            ...
            {sellerVerified && (
              <svg className="w-3.5 h-3.5 text-emerald-500 shrink-0" width={14} height={14} fill="currentColor" viewBox="0 0 20 20">
